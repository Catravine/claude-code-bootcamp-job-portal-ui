          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              ...
              <a href="#" className="group relative hover:text-white transition-colors duration-300">
                ...
                <div
                  role="tooltip"
                  className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-3 w-56 -translate-x-1/2 rounded-lg bg-gray-900 px-3 py-2 text-xs text-gray-100 shadow-xl ring-1 ring-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                >
                  Terms of service are for us to know, and to change at any
                  time. fools.
