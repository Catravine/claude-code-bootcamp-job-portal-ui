  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-primary-400/10 to-red-400/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-tl from-green-400/10 to-red-400/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {categories.map((category) => (
            <button
              ...
              className={`relative group px-8 py-4 rounded-2xl text-sm font-bold transition-all duration-300 transform hover:scale-105 ${
                activeCategory === category
                  ? 'bg-gradient-to-r from-primary-600 via-red-600 to-green-600 text-white shadow-2xl shadow-primary-500/25'
            ...
            >
              ...
              {activeCategory !== category && (
                <div className="absolute inset-0 bg-gradient-to-r from-primary-50 to-red-50 dark:from-primary-900/20 dark:to-red-900/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              )}
            </button>
          ))}
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {displayedJobs.map((job, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-primary-500 via-red-500 to-green-500 rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 blur-xl"></div>
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white group-hover:bg-gradient-to-r group-hover:from-primary-600 group-hover:to-red-600 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
                        {job.title}
                      </h3>
                ...
                <div className="text-2xl font-black bg-gradient-to-r from-primary-600 to-red-600 bg-clip-text text-transparent mb-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {job.skills && job.skills.slice(0, 3).map((skill, tagIndex) => (
                    <span
                      key={skill}
                      className="bg-gradient-to-r from-primary-50 to-red-50 dark:from-primary-900/30 dark:to-red-900/30 text-primary-700 dark:text-primary-300 text-sm font-semibold px-4 py-2 rounded-xl border border-primary-200/50 dark:border-primary-700/50 hover:scale-105 transition-transform duration-200"
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                  ...
                  <div className="relative group overflow-hidden bg-gradient-to-r from-primary-600 to-red-600 hover:from-primary-700 hover:to-red-700 text-white px-6 py-3 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-primary-500/25">
        ...
        {displayCount < filteredJobs.length && (
          <div className="text-center mt-16">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-primary-600 via-red-600 to-green-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
